...
# Connect to MongoDB
client = pymongo.MongoClient("mongodb+srv://adityaece20043:aditya1234@cluster0.njfa2if.mongodb.net/")
db = client["myplaylist"]
# mongodb+srv://adityaece20043:aditya1234@cluster0.njfa2if.mongodb.net/
